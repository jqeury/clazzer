...
( function( winGlobal, fnFactory ) {
   ...
   typeof module === "object" && typeof module.exports === "object" ?
      ...
      // is present, execute the factory and get Clazzer.
      // For environments that do not have a `window` with a `document`
      // (such as Node.js), expose a factory as module.exports.
      // This accentuates the need for the creation of a real `window`.
      // e.g. var Clazzer = require("Clazzer")(window);
      // See ticket #14549 for more info.
      ( module.exports = winGlobal.document ? 
      fnFactory( winGlobal, true ) : function( win ) {
         if ( !win.document ) {
            throw new Error(
               "Clazzer is requires `window` with a :document"
            );
         }
   } ) : fnFactory( winGlobal );
} )( typeof window !== "undefined" ? window : this, function( _window, noGlobal ) {
...
// Attach/Extend Clazzer Library with identifier ent and Expose Clazzer and ent identifier
if ( typeof noGlobal === "undefined" ) {
   window.Clazzer = window.clz = Clazzer;
}
